      ...
      child: Column(
        ...
        children: [
          ...
          FormTextField(
            ...
            validator: (v) {
              ...
              if (!RegExp(r'^05\d{8}$').hasMatch(v)) {
                return 'رقم سعودي غير صالح الرقم يجب أن يبدأ بـ 05 يتكون من 10 ارقام';
              }
              return null;
            },
          ),
          ...
          FormTextField(
            ...
            validator: (v) => v == null || v.isEmpty ? 'ادخل العنوان' : null,
          ),
          SizedBox(height: 20.h),
          Row(
            children: [
            ...
            children: [
              Expanded(
                child: FormTextField(
                  ...
                  validator:
                      (v) => v == null || v.isEmpty ? 'ادخل اسم الشارع' : null,
                ),
              ),
              SizedBox(width: 25.w),
              Expanded(
                child: FormTextField(
                  ...
                  validator:
                      (v) => v == null || v.isEmpty ? 'ادخل رقم المبنى' : null,
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: FormTextField(
                  ...
                  keyboardType: TextInputType.number,
                  validator:
                      (v) => v == null || v.isEmpty ? 'ادخل رقم الشقة' : null,
                ),
              ),
              SizedBox(width: 25.w),
              Expanded(
                child: FormTextField(
                  ...
                  keyboardType: TextInputType.number,
                  validator:
                      (v) => v == null || v.isEmpty ? 'ادخل رقم الدور' : null,
                ),
              ),
            ],
          ),
            ...
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('البيانات محفوظة ✅')),
                );
              }
            },
          ),
